...
let famousPerson = "Albert Einstein once sain,";
...
let withoutWhitspace = whitSpace.trim();
...
let friendsName = ["Yasir Hussain", "Shazaib Khan", "Rumaisa Khan", "Shumaila Shah"];
...
let friends_Name = ["Yasir Hussain", "Shazaib Khan", "Rumaisa Khan", "Shumaila Shah"];
let message1 = "You Are Good Person.";
...
let transportation = ["plan", "car", "bus", "bike",];
...
let guestList = ["Ubaid Ansari", "Jawad Ansari", "Hammad Ansari",];
...
let notComing = "Hammad Ansari";
let newGuest = "Ukasha Ansari";
...
let places = ["dubai", "paris", "new york", "sydney"];
// print your array in its original order.
...
let invitation = ["Ubaid Ansari", "Yasir Hussain"];
...
let mountain_list = ["Mount evrest", "K2", "Himalya", "Margalla hills", "Narga parbat"];
console.log("\n List Of Mountains");
...
let listing1 = ["Mairaj", "Ubaid", "Jawad"];
console.log(listing1[3]);
let listing2 = ["Mairaj", "Ubaid", "Jawad", "Hammad"];
...
let favorite_fruits = ['apple', 'banana', 'grape', 'mango', 'orang'];
...
let users = ['Admin', 'Mairaj', 'Hammad', 'Ubaid', 'Yasir'];
...
let users_ = ['Admin', 'Mairaj', 'Hammad', 'Ubaid', 'Yasir'];
...
let current_users = ["Mairaj", "Jawed", "hammad", "ubaid", "jawaad"];
let new_users = ["mairaj", "jawed", "shumaila", "haniya", "rumaisa"];
...
let pizza_array = ["B.B.Q", "fajida", "maxican"];
...
function describ_city(city, country = "pakistat") {
...
let magician_array = ["magician_array-1", "magician_array-2", "magician_array-3"];
...
let MagicianArray = ["magician_array-1", "magician_array-2", "magician_array-3"];
function make_gread(arr) {
